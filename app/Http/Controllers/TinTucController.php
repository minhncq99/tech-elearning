...
class TinTucController extends Controller
{
    ...
    public function getSua($tinTuc_id)
    {
      $tintuc = tintuc::find($tinTuc_id);
        //$tintuc = tintuc::where('tinTuc_id', $id);
    ...
    {
      $tintuc = DB::table('tintucs')->where('tinTuc_id', $tinTuc_id);
      //$tintuc = tintuc::find($tinTuc_id);
      ...
      $this->validate($request,[
         ...
         // 'Hinh.required'=>'Bạn chưa chọn hình ảnh',
           ...
           //   if($tintuc->Hinh)
           //   {
           //        // $Hinh::delete(file_exists("upload/tintuc/".$Hinh));
           //   }
           //
          ...
          $news = DB::table('tintucs')->where('tinTuc_id', $tinTuc_id)->update(['tenTinTuc'=>$tintuc.tenTinTuc,
          'tomTat'=>$tintuc.tomTat, 'noiDung'=>$tintuc.noiDung, 'moTa'=>$tintuc.moTa,
          'ngayDang'=>$tintuc.ngayDang]); //'Hinh'=>$tintuc.Hinh]);
         //Lưu tin
         //$tintuc->save();
